...
class FacilitiesControllerTest < ActionController::TestCase
  ...
  test "should create facility" do
    assert_difference('Facility.count') do
      post :create, facility: { parking: @facility.parking, refreshment: @facility.refreshment, sc_id: @facility.sc_id, sports_shop: @facility.sports_shop }
    end
  ...
  test "should update facility" do
    patch :update, id: @facility, facility: { parking: @facility.parking, refreshment: @facility.refreshment, sc_id: @facility.sc_id, sports_shop: @facility.sports_shop }
    assert_redirected_to facility_path(assigns(:facility))
  end
